...
export const home: HomeTranslations = {
  ...
  promoBanners: [
    {
      id: 'talent-network',
      title: 'Kết nối cùng các công ty hàng đầu qua TalentNetwork',
      imageAlt: 'Banner TalentNetwork giới thiệu các đối tác tuyển dụng như Acecook, Alphanam, Bảo hiểm Hùng Vương, Duytan, SHB, PGBank, Thiên Long, Viettel Construction, Tous Les Jours, Vietravel, Vietchem và Classic Fine Foods.',
      href: '/companies',
      viewAll: 'Khám phá đối tác',
      image: { src: '/images/home-talent-network-banner.png', width: 1654, height: 419 },
    },
    {
      id: 'cv-templates',
      title: 'CV chuẩn ATS giúp bạn được gọi phỏng vấn nhanh hơn',
      imageAlt: 'Ảnh ứng viên chuẩn bị câu trả lời phỏng vấn với sổ tay, laptop và tablet trên bàn.',
      href: '/cv-templates',
      viewAll: 'Xem mẫu CV',
    ...
    {
      id: 'salary-insights',
      title: 'Biết mức lương trước khi deal',
      imageAlt: 'Banner salary insights hiển thị khoảng lương trung vị và xu hướng tăng trưởng theo năm cho software engineer, product manager, data scientist và UX designer tại Hà Nội, TP.HCM và Đà Nẵng.',
    ...
    {
      id: 'career-guides',
      title: 'Cẩm nang thực chiến từ nhà tuyển dụng',
      imageAlt: 'Ảnh buổi phỏng vấn một-một tại bàn làm việc — ứng viên đối diện nhà tuyển dụng đang cầm bảng câu hỏi.',
      href: '/career-guides',
      viewAll: 'Đọc thư viện',
      image: { src: '/images/banners/home-banner-interview.jpg', width: 1654, height: 1103 },
    },
    {
      id: 'job-alerts',
      title: 'Nhận việc phù hợp mỗi sáng thứ Hai',
      imageAlt: 'Ảnh cận cảnh bắt tay trên bàn họp — biểu tượng cho sự hợp tác và tăng trưởng sự nghiệp.',
      href: '/profile#job-alerts',
      viewAll: 'Tạo job alert',
