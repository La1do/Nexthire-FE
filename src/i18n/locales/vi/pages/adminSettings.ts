...
export const adminSettings: AdminSettingsTranslations = {
  ...
  preferences: { title: 'Tùy chọn và phiên đăng nhập', description: 'Điều chỉnh ngôn ngữ hoặc kết thúc phiên quản trị hiện tại.', language: 'Ngôn ngữ hiển thị', languageHint: 'Lựa chọn được áp dụng cho toàn bộ giao diện NexHire.', sessionTitle: 'Phiên đăng nhập', sessionDescription: 'Đăng xuất an toàn khỏi thiết bị này.', logout: 'Đăng xuất' },
