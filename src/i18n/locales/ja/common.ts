export const common = {
  ...
  loader: {
    applyingCvParseLabel: 'CVからプロフィールを更新しています...',
    bootLabel: 'NexHireを読み込んでいます...',
    checkingSessionLabel: 'ログインセッションを確認しています...',
    defaultLabel: '処理中...',
    deletingCvLabel: 'CVを削除しています...',
    googleLoginLabel: 'Googleでログインしています...',
    loginLabel: 'ログインしています...',
    logoutLabel: 'ログアウトしています...',
    parsingCvLabel: 'CVを解析しています...',
    passwordResetRequestLabel: '確認コードを送信しています...',
    passwordResetSaveLabel: '新しいパスワードを保存しています...',
    regionLabel: '処理状況',
    registerLabel: 'アカウントを作成しています...',
    savingProfileLabel: 'プロフィールを保存しています...',
    uploadingAvatarLabel: 'アバターをアップロードしています...',
    uploadingCvLabel: 'CVをアップロードしています...',
    verifyEmailLabel: 'メールを確認しています...',
  },
  apiErrors: {
