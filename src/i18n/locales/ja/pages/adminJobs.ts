...
export const adminJobs: AdminJobsTranslations = {
  ...
  detail: { title: '審査詳細', description: '仕事内容', requirements: '応募要件', benefits: '福利厚生', skills: 'スキル', moderation: '審査分析', reasons: '警告理由', rules: '該当ルール', reasonLabels: { 'Job description is too short': '求人説明が短すぎます', 'Job requirements are missing or too vague': '求人要件が不足しているか不明確です' }, ruleLabels: { LOW_DESCRIPTION_LENGTH: '求人説明が短すぎます', MISSING_OR_WEAK_REQUIREMENTS: '求人要件が不足しているか不明確です', CLIENT_SITE_SCOPE: 'クライアントの勤務地範囲', MULTI_LEVEL_PATTERN: 'マルチ商法の疑いがある表現', MISSING_COMPENSATION: '給与または待遇情報が不足しています' }, changeSummary: '変更概要', noData: 'データなし', close: '閉じる' },
