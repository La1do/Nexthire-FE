...
export const adminUsers: AdminUsersTranslations = {
  ...
  detail: { routeLabel: 'User details', back: 'Back to users', title: 'User information', contact: 'Contact', lifecycle: 'Account lifecycle', company: 'Company', noCompany: 'No company', emailVerified: 'Email verified', emailUnverified: 'Email not verified', statusReason: 'Status reason', changedAt: 'Changed at', createdAt: 'Created', updatedAt: 'Updated', lastLoginAt: 'Last login' },
  currentUser: {
    name: 'Man Ha',
