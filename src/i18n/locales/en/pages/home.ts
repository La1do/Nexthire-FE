...
export const home: HomeTranslations = {
  ...
  promoBanners: [
    {
      id: 'talent-network',
      title: 'Connect with leading employers through TalentNetwork',
      imageAlt: 'TalentNetwork banner featuring hiring partners such as Acecook, Alphanam, Bao Viet, Duytan, SHB, PGBank, Thien Long, Viettel Construction, Tous Les Jours, Vietravel, Vietchem and Classic Fine Foods.',
      href: '/companies',
      viewAll: 'Explore partners',
      image: { src: '/images/home-talent-network-banner.png', width: 1654, height: 419 },
    },
    {
      id: 'cv-templates',
      title: 'Land interviews with ATS-ready CV templates',
      imageAlt: 'Wide-format photo of a candidate preparing interview answers across a desk with notebook, laptop and tablet.',
      href: '/cv-templates',
      viewAll: 'Browse templates',
      image: { src: '/images/banners/home-banner-coding.jpg', width: 1654, height: 1103 },
    },
    {
      id: 'salary-insights',
      title: 'Know the market before you negotiate',
      imageAlt: 'Salary insights banner showing median pay ranges and year-over-year trends for software engineers, product managers, data scientists and UX designers across Hanoi, HCMC and Da Nang.',
      href: '/salary-insights',
      viewAll: 'See full report',
      image: { src: '/images/banners/home-banner-salary-insights.svg', width: 1654, height: 419 },
    },
    {
      id: 'career-guides',
      title: 'Practical guides from recruiters who actually hire',
      imageAlt: 'Wide-format photo of a one-on-one interview conversation at a desk, with a candidate facing an interviewer holding a clipboard.',
      href: '/career-guides',
      viewAll: 'Read the library',
      image: { src: '/images/banners/home-banner-interview.jpg', width: 1654, height: 1103 },
    },
    {
      id: 'job-alerts',
      title: 'Get the right roles in your inbox every Monday',
      imageAlt: 'Wide-format photo of a candidate speaking during a structured interview at a desk in a modern office.',
      href: '/profile#job-alerts',
      viewAll: 'Set up alerts',
